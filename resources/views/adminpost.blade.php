...
<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet">
    <x-slot name="header">
        ...
        <i class="fa fa-bell">&nbsp;</i> {{ __('Please write your comments/suggestion on the form provided below:') }}
        </h2>
    </x-slot>
